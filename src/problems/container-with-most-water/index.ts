  ...
  solutions: [
    {
      ...
      steps: [
        ...
        {
          lines: [7, 8, 9],
          label: "Both walls are tall now — best area so far by a wide margin. The right wall (6) is the new shorter one.",
        ...
        {
          lines: [16],
          label: "Right wall (3) is still shorter — move it. Both walls are now equal height, but the narrowed width keeps the area well under 36.",
          variables: { l: "1", r: "5", area: "28", maxArea: "36" },
          visuals: [arr(1, 5, [1, 5])],
        },
        {
          lines: [16],
          label: "Walls are equal — by convention move right. Area is limited by the shorter wall (4) and the narrowing width. Not a new best.",
          variables: { l: "1", r: "4", area: "12", maxArea: "36" },
          visuals: [arr(1, 4, [1, 4])],
        },
        {
          lines: [16],
          label: "Right wall (4) is shorter — move it. Walls are getting closer; the window is almost closed.",
          variables: { l: "1", r: "3", area: "10", maxArea: "36" },
          visuals: [arr(1, 3, [1, 3])],
        },
        {
          lines: [16],
          label: "Right wall (5) is shorter — move it. Just one slot wide now; tiny area.",
